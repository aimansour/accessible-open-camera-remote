...
· [Windows release v0.1.3](https://github.com/aimansour/accessible-open-camera-remote/releases/tag/v0.1.3)
...
were checked in Arabic and English. The user confirmed that NVDA works with
v0.1.3 and reported USB-C microphone sound working in an earlier session. The latest local opt-in
